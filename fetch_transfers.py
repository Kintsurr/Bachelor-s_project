...
SELECTED_COLUMNS = [
    "player_id", "id", "clubFrom.id", "clubTo.id", "date", "season"
]
            ...
            if response.status_code == 200:
                ...
                if isinstance(data, dict) and data:
                    ...
                    for transfer in transfers:
                        club_from = transfer.get("clubFrom", {})
                        club_to = transfer.get("clubTo", {})
                        player_data = {
                            "player_id": id_value,
                            "transfer_id": transfer.get("id", ""),
                            "clubFrom": club_from.get("id", ""),
                            "clubTo": club_to.get("id", ""),
                            "date": transfer.get("date", ""),
                            "season": transfer.get("season", ""),
                            "marketValue": transfer.get("marketValue", "")
                        }
