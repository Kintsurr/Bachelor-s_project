...
CLUB_IDS = set(load_existing_ids("./data/club_players.csv"))
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if isinstance(data, dict) and data:
                    ...
                    value_history_list = []
                    for marketValueHistory in marketValueHistory:
                        player_data = {
                            "player_id": id_value,
                            "club_id": marketValueHistory.get("clubId", ""),
                            "date": marketValueHistory.get("date", ""),
                            "age": marketValueHistory.get("age", ""),
                            "market_value": marketValueHistory.get("marketValue", "")
                        }
